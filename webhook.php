...
// Set Variables
$LOCAL_ROOT         = "/home/anthonycastaneda/SatanBot";
$LOCAL_REPO_NAME    = "SatanBot";
$LOCAL_REPO         = "{$LOCAL_ROOT}/{$LOCAL_REPO_NAME}";
$REMOTE_REPO        = "git@github.com:anthonycastaneda/satanbot.git";
$BRANCH             = "master";
...
if ( $_POST['payload'] ) {
  ...
  if( file_exists($LOCAL_REPO) ) {
    ...
    shell_exec("cd {$LOCAL_REPO} && git fetch origin master && git checkout master && git pull");
