...
module.exports = {
	...
	async execute(interaction) {
		...
		const embedSatan = new MessageEmbed()
			...
			.addFields(
				{ name: '♀️', value: 'Consistent with our tenets that call for bodily autonomy and acting in accordance with best scientific evidence, The Satanic Temple religiously objects to many of the restrictions that states have enacted that interfere with abortion access as well as other related issues that affect members religious right', inline: false },
