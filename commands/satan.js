...
module.exports = {
	...
	async execute(interaction) {
		...
		const embedSatan = new MessageEmbed()
			...
			.setImage('https://anthonycastaneda.com/img/baph-poster.png')
			...
			.addFields(
				{ name: '♀️', value: 'Consistent with our tenets that call for bodily autonomy and acting in accordance with best scientific evidence, The Satanic Temple religiously objects to many of the restrictions that states have enacted that interfere with abortion access as well as other related issues that affect members religious rights', inline: false },
				{ name: '🚩', value: 'Protect Mental Health, Particularly In The Area Of So-Called “Repressed Memories.”', inline: false },
				{ name: '🏫', value: 'The Protect Children Project Addresses Abuses That Take Place In Public Schools That Are Perpetrated By School Officials And Are Deemed Legal.', inline: false },
